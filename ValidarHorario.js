$(document).ready(function(){
	...
	function setearHoras(){
		...
		$('.time').append('<option value="2130">22:15</option>');
	}
...
//		$('#domingoFin').val(domingo.substring(6,11));
		...
		var _profesor = profesor.split(",")[0];
		var docente = _profesor.split(" ")[0] + "" + _profesor.split(" ")[1];
		var value_docente = docente.toString();
